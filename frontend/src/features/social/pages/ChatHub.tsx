...
import { Search, Send, Image as ImageIcon, Smile, MoreVertical, Phone, Video, Check, CheckCheck, MessageCircle, ShieldCheck, Trash2, Users, X, UserPlus } from 'lucide-react';
                    ...
                    <div className="p-4 bg-white/[0.02] border-t border-white/5 m-3 rounded-[2.5rem]">
                        <div className="flex items-center gap-3">
                            <div className="flex gap-1 shrink-0">
                                <button className="p-3 text-gray-500 hover:text-primary transition-all hover:bg-white/5 rounded-full"><Smile className="w-5 h-5" /></button>
                                <button className="p-3 text-gray-500 hover:text-primary transition-all hover:bg-white/5 rounded-full"><ImageIcon className="w-5 h-5" /></button>
                            </div>
                            <input
                                type="text"
